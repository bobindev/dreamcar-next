...
interface CommunityCardProps {
	...
	size?: string;
  likeArticleHanler: any;
}

const CommunityCard = (props: CommunityCardProps) => {
	const { boardArticle, likeArticleHanler, size = 'normal' } = props;
			...
			>
				...
				<Stack className="desc-box" sx={{ marginTop: '-20px' }}>
					...
					<Stack className={'buttons'}>
						...
						<IconButton color={'default'} onClick={(e: any) => likeArticleHanler(e, user, boardArticle?._id)}>
