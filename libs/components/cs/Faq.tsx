...
import { FaqCategory } from '../../enums/faq.eum';
import { GET_FAQ } from '../../../apollo/admin/query';
import { useQuery } from '@apollo/client';
import { Faqs } from '../../types/faq/faq';

const Accordion = styled((props: AccordionProps) => <MuiAccordion disableGutters elevation={0} 
//mileage 
{...props} />)(
	({ theme }) => ({
...
const Faq = () => {
	...
	const [category, setCategory] = useState<FaqCategory>(FaqCategory.VEHICLES);
		...
		return (
			<Stack className={'faq-content'}>
				<Box className={'categories'} component={'div'}>
					<div
						className={category === 'VEHICLES' ? 'active' : ''}
						onClick={() => {
							changeCategoryHandler(FaqCategory.VEHICLES);
						}}
					>
						Vehicles
					</div>
